...
export const fr = {
  ...
  landing: {
    ...
    pricingTitle: 'Tarifs',
    pricingNote:
      'Sans engagement, vous changez d’offre quand vous voulez. Vos données et votre historique restent les vôtres.',
    ...
    plans: [
      {
        ...
        pitch: 'Être en ligne.',
        features: [
          '30 rendez-vous en ligne par mois',
      ...
      },
      {
        ...
        price: '3 000 DZD',
        period: 'par mois',
        pitch: 'Faire tourner le salon.',
        features: [
          'Rendez-vous illimités',
          'Équipe illimitée, horaires et absences par personne',
          'Fiches clientes et segments',
          'Relances WhatsApp',
      ...
      },
      {
        ...
        price: '5 500 DZD',
        period: 'par mois',
        pitch: 'Piloter le commerce.',
        features: [
          'Caisse : ventes, dépenses, encaissement en un clic',
          'Stocks : quantités, mouvements, alertes',
          'Blocage des numéros abusifs',
